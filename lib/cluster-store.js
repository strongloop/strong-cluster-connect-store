...
module.exports = function(connect) {
   ...
   * See the [strong-store-cluster](http://docs.strongloop.com/strongloop/strong-store-cluster#collectionconfigureoptions)
   *  documentation for information on the options.
   *
   * ClusterStore is an implementation of session store using node's native
   * cluster messaging.
   *
